  ...
  vermelha: [
    {
      ...
      img: "../../assets/images/logo/logo2.png",
      nucleo: '',
      historia: 'Comecei em 1978, por ser comerciário, no SESC do Setor Universitário, levado pelos amigos Celso (Cuecão) e Celmo. Na época, o responsável pelo grupo era o Mestre Passarinho, e o grupo chamava-se Grupo de Capoeira São Bento Pequeno do SESC. O Mestre Passarinho estava no Serviço Militar e o aluno mais velho e responsável pelo grupo era o Mestre Suíno, que na época tinha a graduação de lenço vermelho. Os alunos daquela época eram: Gafanhoto, Ganso, Minhocão, Descrente, Dragão, Macha Lenta, Macarrão, Strogonof, Curraleiro, Zorro, Doença, Cabaça, Kiko, Índio, Louva-Deus, Linguicinha, Salário Mínimo, Esqueci, Cabeça, Chorão, Piolho, Traíra, Lobó, Maguila, Dimorié, Xita, Tiziu, Chinelo, Girafa (Goiano), Coqueiro (Charm) e Foquinha. E as mulheres eram Salsicha, Requenguela, Lagartixa e Nega Tarú. Em janeiro de 1979, o Mestre Passarinho retornou à liderança do grupo após cumprir o tempo de serviço militar. Os treinos aconteciam no clube do SESC, na sala do primeiro andar, onde era o salão de festas. Afastávamos as mesas e cadeiras, limpávamos o salão e treinávamos aos sábados à tarde e domingos pela manhã. Em janeiro de 1979, peguei o primeiro lenço azul da sequência de Mestre Bimba e ganhei o primeiro campeonato interno.'
    },
    {
      id: 'besouro',
