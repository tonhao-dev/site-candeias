export const dadosMestres = {
  branca: [
    ...
    {
      id: "tourinho",
      nome: "PORFÍRIO JUNIOR BASTOS DE ALMEIDA",
      apelido: "MESTRE TOURINHO",
      instagram: "",
      inicio: "1976",
      pais: "Brasil",
      bandeira: "brasil",
      ...
      nucleo: "Anápolis",
      historia:
        "Sou conhecido como MESTRE TOURINHO. Nasci em Brasília em 07 de março de 1960 e me mudei para Anápolis/GO aos cinco anos de idade. Iniciei na capoeira em 1976 com o Badoê e, após sua saída, continuei com o Dimenor e fui formado pelo Mestre Bodão. Em 1994, ingressei no Grupo Candeias, aceitando humildemente começar como iniciante, apesar da experiência e títulos que já possuía. No Candeias, fui campeão goiano duas vezes e campeão brasileiro, além de realizar importantes eventos como a extensão do Open em Anápolis e o Ginga Show. Formei diversos alunos, como os Contramestres Cabeção e David, o Professor Martelo e o Instrutor Cristiano. Desde 2001 trabalho em meu próprio espaço, que há sete anos passou a se chamar Capoeira de Cristo. Em 2011 iniciei o curso de Teologia, concluído em 2015, e desde então evangelizo por meio da capoeira. São mais de 40 anos de dedicação, superações e ensinamentos, mantendo a fé e perseverança como guia da minha missão.",
    },
  ],
  brancaVermelha: [
    {
